...
namespace EcdlBooking.Data.Migrations
{
    ...
    [Migration("20250816150640_Scheduler_Relazione_Alunno")]
    partial class Scheduler_Relazione_Alunno
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserSchedulerEcdl", b =>
                {
                    ...
                    b.HasKey("ReservationId", "StudenteId");

                    b.HasIndex("StudenteId");

                    b.ToTable("ApplicationUserSchedulerEcdl");
                });
            ...
            modelBuilder.Entity("EcdlBooking.Models.School", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = new Guid("b8cf9e13-5196-44d6-bfda-02756cdea325"),
                            City = "Rovereto",
                            Name = "Iti G. Marconi"
                        });
                });
            ...
            modelBuilder.Entity("ApplicationUserSchedulerEcdl", b =>
                {
                    b.HasOne("EcdlBooking.Models.SchedulerEcdl", null)
                        .WithMany()
